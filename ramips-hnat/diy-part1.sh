...
echo 'src-git routing https://github.com/openwrt/routing.git^18168b3468' >>feeds.conf.default
echo 'src-git telephony https://github.com/openwrt/telephony.git^b1bfd7d375' >>feeds.conf.default
